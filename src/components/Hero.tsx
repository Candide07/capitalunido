...
const Hero = ({ t, country, lang, onCTA }: HeroProps) => {
  ...
  const getColors = () => {
    switch (country.code) {
      case 'pe':
        return {
          badgeGradient: 'from-[#D91023]/10 to-[#fcd116]/10',
          badgeBorder: 'border-[#D91023]/30',
          badgeText: 'text-gray-800',
          titleGlow: 'from-[#D91023] via-[#fcd116] to-[#D91023]',
          titleGradient: 'from-[#D91023] to-[#fcd116]',
          titleText: 'text-gray-900',
          priceGradient: 'from-[#fcd116] to-[#D91023]',
          priceText: 'text-[#D91023]',
          buttonGradient: 'from-[#D91023] via-[#fcd116] to-[#D91023]',
          buttonShadow: 'shadow-[#D91023]/40 hover:shadow-[#D91023]/60',
          imageGlow: 'from-[#D91023] via-[#fcd116] to-[#D91023]',
          badgeBg: 'from-[#D91023] to-[#8B0000]',
          badgeBorderColor: 'border-[#fcd116]',
          trustBadgeBg: 'from-[#1a3c6e] to-[#D91023]',
      ...
      case 'mx':
        return {
          badgeGradient: 'from-[#006341]/10 to-[#CE1126]/10',
          badgeBorder: 'border-[#006341]/30',
          badgeText: 'text-gray-800',
          titleGlow: 'from-[#006341] via-[#CE1126] to-[#006341]',
          titleGradient: 'from-[#006341] to-[#CE1126]',
          titleText: 'text-gray-900',
          priceGradient: 'from-[#CE1126] to-[#006341]',
          priceText: 'text-[#006341]',
          buttonGradient: 'from-[#006341] via-[#CE1126] to-[#006341]',
          buttonShadow: 'shadow-[#006341]/40 hover:shadow-[#006341]/60',
          imageGlow: 'from-[#006341] via-[#CE1126] to-[#006341]',
          badgeBg: 'from-[#006341] to-[#003d2b]',
          badgeBorderColor: 'border-[#CE1126]',
          trustBadgeBg: 'from-[#1a3c6e] to-[#006341]',
          subtitleText: 'text-gray-700',
          guaranteeText: 'text-gray-500',
          priceBg: 'bg-white/80',
          oldPriceText: 'text-gray-400',
      ...
      default:
        return {
          ...
          badgeText: 'text-gray-800',
          titleGlow: 'from-[#ef2b2d] via-[#fcd116] to-[#009e49]',
          titleGradient: 'from-[#fcd116] via-[#ef2b2d] to-[#fcd116]',
          titleText: 'text-gray-900',
          priceGradient: 'from-[#fcd116] to-[#ef2b2d]',
          priceText: 'text-[#fcd116]',
          buttonGradient: 'from-[#fcd116] via-[#ef2b2d] to-[#009e49]',
          buttonShadow: 'shadow-[#fcd116]/40 hover:shadow-[#fcd116]/60',
          imageGlow: 'from-[#ef2b2d] via-[#1a3c6e] to-[#009e49]',
          badgeBg: 'from-[#009e49] to-[#1a3c6e]',
          badgeBorderColor: 'border-[#fcd116]',
          trustBadgeBg: 'from-[#1a3c6e] to-[#ef2b2d]',
          subtitleText: 'text-gray-700',
          guaranteeText: 'text-gray-500',
          priceBg: 'bg-white/80',
          oldPriceText: 'text-gray-400',
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center mb-16 pt-8">
      ...
      <div className="relative group animate-fade-in-up" style={{animationDelay: '300ms'}}>
        ...
        <div className={`absolute -bottom-6 -right-6 bg-gradient-to-br ${colors.badgeBg} rounded-3xl p-6 shadow-2xl animate-fadeIn hover:scale-110 transition-transform duration-300 border-2 ${colors.badgeBorderColor}`}>
          ...
          <div className="text-sm font-bold text-[#fcd116]">
